...
import { Save, Webhook, TestTube, Bot } from 'lucide-react';
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            <Button
              ...
              variant="outline"
              size="sm"
              className="font-mono retro-button"
            >
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <RectangularSwitch checked={enableHistory} onCheckedChange={setEnableHistory} />
          </div>
        </div>
